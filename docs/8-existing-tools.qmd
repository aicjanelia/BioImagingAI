...
# How to find and select a tool {#sec-8}
::: {.content-visible when-format="pdf"}
| **Beth Cimini & Erin Weisbart**
...
## Workflows contain modular components

![Adapted from @Haase2024.](8-existing-tools_files/workflows.png){#fig-workflows}
...
- **What is your desired output?**   
  ...
  If so, do you need [semantic](glossary.qmd#semantic-segmentation), [instance](glossary.qmd#instance-segmentation), or [panoptic segmentation](glossary.qmd#panoptic-segmentation) ([Box 8.1](#Box1))? (see @sec-4 and @sec-9 for more information)
...
- **How will you assess your outputs?**  
  ...
  Do you have the expertise to assess output quality? (see @sec-output_quality for more information)
- **What is your desired "quality" of your outputs?**  
  Are you expecting outputs that approach [ground truth](glossary.qmd#ground-truth) or will "quick and dirty" be enough for you?
...
- **What is your priority?**  
  ...
  Perhaps you have a specific [quality control (QC) metric](glossary.qmd#quality-control-metric) and you need the tool that will give you the outputs that optimize this metric.
...
- **How difficult are your images?**  
  ...
  - Do you have [metadata](glossary.qmd#metadata) that needs to be associated with your images?
...
We generally factor in two major considerations when deciding what quality level we are aiming to achieve: Is this a pilot or final data? and How big is the [effect size](glossary.qmd#effect-size) we're looking for? 
...
![Research progress is rarely linear](8-existing-tools_files/research_progress.png "Research progress is rarely linear"){#fig-research-progress}
...
Let's consider the use case of instance segmentation (see [Box 8.1](#Box1)), which is often a critical step in image analysis workflows.
...
* [Manual annotation](glossary.qmd#manual-annotation)   
...
They are covered in @sec-9.

It is worth noting that many of the tool suggestions below are not confined to a single "class".
Many tools listed in the non-deep learning categories allow you to run pre-trained deep learning models inside them (e.g. CellProfiler has a RunCellPose module, ImageJ and QuPath also contain ability to run [pixel classifiers](glossary.qmd#pixel-classifiers)). 
...
This makes using normal [computer vision](glossary.qmd#computer-vision) segmentation quite hard. 
