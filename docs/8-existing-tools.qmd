...
# How do you select and find a tool? {#sec-8}
...
- **What is your desired output?**   
  ...
  If so, do you need [semantic](glossary.qmd#semantic-segmentation), [instance](glossary.qmd#instance-segmentation), or [panoptic segmentation](glossary.qmd#panoptic-segmentation) ([Box 1](#Box1))? (see @sec-4 and @sec-9 for more information)
