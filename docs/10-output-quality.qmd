...
Suppose you have fluorescently labelled nuclei, as in ([@fig-todo]), that you want to segment for downstream analysis.
...
However a model that misses nuclei ([@fig-segmentations]c), merges multiple nuclei into one ([@fig-segmentations]b), or splits a single nucleus into multiple (Fig TODO) would introduce errors into the final counts. 
