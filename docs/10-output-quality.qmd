...
- Some metrics (e.g. ones that require matching) may be too computationally intensive to compute during training on validation
- Separation between the metrics you compute on validation (to choose your model/checkpoint) and the metrics you compute on tests (to understand the limitations of your pipeline)
